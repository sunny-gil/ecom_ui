...
const About = () => {
  ...
  return (
    <>
      <Header />
      <section className="relative pt-24 overflow-hidden bg-gradient-to-b from-green-50/50 via-white to-white text-gray-900">
        ...
        <motion.div
          ...
          className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-green-200/30 blur-[120px] rounded-full pointer-events-none"
        />
        <motion.div
          animate={{
            y: [0, -30, 0],
          ...
          className="absolute bottom-[-100px] right-[-100px] w-[500px] h-[500px] bg-amber-100/30 blur-[150px] rounded-full pointer-events-none"
        />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 z-10">
          ...
          >
            <motion.span 
              ...
              className="text-green-700 font-bold tracking-widest text-sm uppercase bg-green-50 border border-green-100 px-6 py-2 rounded-full backdrop-blur-md"
            >
              ✦ Our Philosophy
            </motion.span>
            <h1 className="text-5xl md:text-7xl font-black mt-8 tracking-tighter leading-tight text-gray-900">
              Elevating the Art of <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-600 via-amber-600 to-green-700 animate-gradient">
                Everyday Living
              </span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
            ...
            <TiltCard className="relative group cursor-pointer h-[550px] flex items-center justify-center">
              ...
              <div 
                className="relative z-10 overflow-hidden rounded-[30px] border border-gray-200 bg-white p-4 shadow-xl w-full h-[500px] flex items-center justify-center"
              ...
              >
                ...
                {/* Floating 3D tag */}
                <div 
                  className="absolute bottom-10 right-10 bg-white/90 backdrop-blur-xl px-8 py-4 rounded-2xl border border-gray-100 z-20 shadow-xl"
                  style={{ transform: "translateZ(60px)" }}
                >
                  <p className="text-green-700 font-bold text-3xl tracking-tight">100%</p>
                  <p className="text-gray-500 text-sm font-semibold tracking-wider">PURE SELECTION</p>
                </div>
              </div>
            </TiltCard>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <motion.div 
                    ...
                    className="flex items-center space-x-3 bg-green-50/50 border border-green-100 p-3 rounded-xl hover:bg-green-50 transition-colors"
                  >
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Pillars of the Brand</h2>
              <p className="text-gray-600 text-lg max-w-xl mx-auto">Precision and care embedded within our DNA.</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <TiltCard key={i} className="cursor-pointer">
                  <div className="h-full p-8 bg-white border border-gray-100 rounded-[24px] text-center shadow-md hover:shadow-xl hover:bg-green-50/20 transition-all duration-300 group">
                    <div className="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-6 transition-transform">
                      {pillar.icon}
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3 tracking-tight">{pillar.title}</h3>
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Meet Our Founders</h2>
              <p className="text-gray-600 text-lg max-w-xl mx-auto">The visionaries behind our premium lifestyle e-commerce store.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <TiltCard className="cursor-pointer">
                <div className="bg-white rounded-[30px] border border-gray-100 shadow-lg p-8 flex flex-col md:flex-row gap-8 items-center hover:shadow-2xl transition-all duration-300">
                  <div className="w-48 h-48 rounded-[20px] overflow-hidden bg-gray-50 flex-shrink-0 border border-gray-200">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-gray-900 mt-3 mb-2">Sunny Gill</h3>
              ...
              <TiltCard className="cursor-pointer">
                <div className="bg-white rounded-[30px] border border-gray-100 shadow-lg p-8 flex flex-col md:flex-row gap-8 items-center hover:shadow-2xl transition-all duration-300">
                  ...
                  <div>
                    <span className="text-green-600 font-bold text-sm uppercase tracking-widest bg-green-50 px-3 py-1 rounded-full">
                      Creative Director
                    </span>
                    <h3 className="text-2xl font-bold text-gray-900 mt-3 mb-2">Rajkumari Jatt</h3>
                    <p className="text-gray-600 text-sm leading-relaxed">
