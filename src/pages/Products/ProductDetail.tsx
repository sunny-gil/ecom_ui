    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow pt-28 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <button
            onClick={() => navigate("/products")}
            className="flex items-center text-gray-600 hover:text-green-600 mb-8 transition"
          >
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="bg-green-50 p-10 flex items-center justify-center relative">
              ...
              <div className="p-10 flex flex-col justify-center">
                ...
                >
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <span className="text-gray-600 ml-2 text-sm">({product.reviews} reviews)</span>
                  </div>
            ...
            {/* Tabs Section */}
            <div className="border-t border-gray-100 p-10 bg-white">
              ...
              <motion.div
                ...
                className="text-gray-600 text-lg leading-relaxed min-h-[150px]"
              >
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {relatedProducts.map((rp, i) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{rp.name}</h3>
                      <p className="text-green-600 font-bold text-lg">₹{rp.price}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
